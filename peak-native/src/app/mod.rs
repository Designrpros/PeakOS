...
pub struct PeakNative {
    ...
    // Advanced Dock State
    pub pinned_apps: Vec<crate::registry::AppId>,
    pub running_apps: Vec<crate::registry::AppId>,
    pub dragging_app: Option<(crate::registry::AppId, usize)>, // (AppId, original_index)
    pub context_menu_app: Option<crate::registry::AppId>,
