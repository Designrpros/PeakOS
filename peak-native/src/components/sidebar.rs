...
fn secondary_button_style(status: button::Status, palette: crate::theme::Palette) -> button::Style {
    button::Style {
...
fn danger_button_style(status: button::Status, _palette: crate::theme::Palette) -> button::Style {
    button::Style {
        background: match status {
