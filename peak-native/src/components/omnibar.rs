...
impl Omnibar {
    ...
    fn view_menu_item(
        ...
        let icon = iced::widget::svg(crate::icons::get_ui_icon(item.icon(), icon_color))
    ...
    fn view_search_result<'a>(
        ...
        let icon = if let Some(app_id) = result.app_id {
            iced::widget::svg(crate::icons::get_app_icon(app_id, icon_color))
                .width(Length::Fixed(16.0))
                .height(Length::Fixed(16.0))
        } else {
            iced::widget::svg(crate::icons::get_ui_icon("document", icon_color))
                .width(Length::Fixed(16.0))
                .height(Length::Fixed(16.0))
        };
