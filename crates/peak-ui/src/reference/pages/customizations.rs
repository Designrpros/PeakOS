...
pub fn view(_context: &Context, is_mobile: bool) -> Box<dyn View<Message, IcedBackend>> {
    Box::new(
        VStack::new_generic()
            ...
            .push(Text::<IcedBackend>::new("Learn how to customize themes, colors, and global styles.").title3().secondary())
            ...
            .push(ProxyView::new(move |theme_ctx| {
                ...
                container(
                    VStack::new_generic()
                        ...
                        .push(Text::<IcedBackend>::new("PeakUI uses ThemeTokens to control everything from colors to border radii. You can swap themes at runtime for instant UI updates.").secondary())
                        .view(theme_ctx)
                )
                .padding(40)
